  ...
  if (!ticket) {
    return (
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-10">
        ...
        <Link href="/suporte" className="mt-4 inline-block text-sm text-green-700 hover:underline">
          Voltar para Suporte
        </Link>
      </main>
    );
  ...
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-10">
      <header className="mb-6">
        <Link href="/suporte" className="text-sm text-green-700 hover:underline">
          ← Voltar para Suporte
        </Link>
